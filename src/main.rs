...
fn main() {
            ...
            if (center - Point3::new(4.0, 0.2, 0.0)).length() > 0.9 {
                ...
                match choose_mat {
                    x if x < 0.8 => {
                        ...
                        let center2 = center + Vec3::new(0.0, random_double_with_range(0.0, 0.5), 0.0);
    ...
    let mut camera = Camera::new(1200, 16.0 / 9.0, 1, 10, 20.0, Point3::new(13.0, 2.0, 3.0), Point3::new(0.0, 0.0, 0.0), Vec3::new(0.0, 1.0, 0.0), 0.6, 10.0);
